...
# Normalize data acroos all training and testing points using shift and scale
def normalizeData():
    global trainVal
    global trainTarget
    global testVal
...
# Calculate w for the testing points
def calculateW(X,Y):
    global lam
    X=np.matrix(X)
...
# Predict test point labels using w calculated for traing points
...
# calculate mean square error for the predicted and actual values
